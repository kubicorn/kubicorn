...
docker run --rm -v "/${DIR}/.."://go/src/github.com/kubicorn/kubicorn -v "/${GOPATH}/bin"://go/bin -w //go/src/github.com/kubicorn/kubicorn golang:1.13 ${MAKE_COMMAND} ${VERBOSE_DOCKER_RUN}

...
func bootstrapGoogle_compute_k8s_ubuntu_1604_masterSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/google_compute_k8s_ubuntu_16.04_master.sh", size: 1776, mode: os.FileMode(493), modTime: time.Unix(1502701618, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapGoogle_compute_k8s_ubuntu_1604_nodeSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/google_compute_k8s_ubuntu_16.04_node.sh", size: 1246, mode: os.FileMode(493), modTime: time.Unix(1502701618, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

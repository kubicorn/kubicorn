...
func bootstrapGoogle_compute_k8s_ubuntu_1604_masterSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/google_compute_k8s_ubuntu_16.04_master.sh", size: 1946, mode: os.FileMode(493), modTime: time.Unix(1502914632, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapGoogle_compute_k8s_ubuntu_1604_nodeSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/google_compute_k8s_ubuntu_16.04_node.sh", size: 1246, mode: os.FileMode(493), modTime: time.Unix(1502823099, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

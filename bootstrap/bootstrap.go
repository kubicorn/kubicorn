...
func bootstrapDigitalocean_k8s_ubuntu_1604_masterSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/digitalocean_k8s_ubuntu_16.04_master.sh", size: 1760, mode: os.FileMode(420), modTime: time.Unix(1505269373, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapDigitalocean_k8s_ubuntu_1604_nodeSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/digitalocean_k8s_ubuntu_16.04_node.sh", size: 1290, mode: os.FileMode(420), modTime: time.Unix(1505269373, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapVpnOpenvpnmasterSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/vpn/openvpnMaster.sh", size: 4888, mode: os.FileMode(420), modTime: time.Unix(1505269373, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapVpnOpenvpnnodeSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/vpn/openvpnNode.sh", size: 951, mode: os.FileMode(420), modTime: time.Unix(1505269373, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

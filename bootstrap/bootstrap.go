...
func bootstrapAmazon_k8s_centos_7_masterSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/amazon_k8s_centos_7_master.sh", size: 2307, mode: os.FileMode(420), modTime: time.Unix(1502763847, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapAmazon_k8s_centos_7_nodeSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/amazon_k8s_centos_7_node.sh", size: 1774, mode: os.FileMode(420), modTime: time.Unix(1502763847, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

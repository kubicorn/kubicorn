...
func bootstrapDigitalocean_k8s_centos_7_masterSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/digitalocean_k8s_centos_7_master.sh", size: 2120, mode: os.FileMode(436), modTime: time.Unix(1502311291, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapDigitalocean_k8s_centos_7_nodeSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/digitalocean_k8s_centos_7_node.sh", size: 1620, mode: os.FileMode(436), modTime: time.Unix(1502335359, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapVpnOpenvpnmasterCentosSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/vpn/openvpnMaster-centos.sh", size: 4870, mode: os.FileMode(436), modTime: time.Unix(1502387902, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func bootstrapVpnOpenvpnnodeCentosSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "bootstrap/vpn/openvpnNode-centos.sh", size: 960, mode: os.FileMode(436), modTime: time.Unix(1502387952, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
